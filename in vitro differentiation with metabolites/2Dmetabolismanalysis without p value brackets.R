...
datforposterplot<-subset(datforposter,datforposter$Lipid.level!='8x Lipid')
# plot
plot1<-ggplot(datforposterplot,aes(x=condition,y=cd49acountperul))+
...
datforposterplot<-subset(datforposter,datforposter$Lipid.level!='8x Lipid')
# plot
plot2<-ggplot(datforposterplot,aes(x=factor(condition),y=freq.CD49apos))+
  stat_summary(fun=mean, geom="col",aes(fill=Glucose.level))+ 
  geom_jitter(aes(color=Lipid.level),alpha=.8,size=.75)+
  scale_color_viridis("Lipid Level",discrete=T,option = 'mako',begin =.3,end=.8)+
  scale_fill_viridis("Glucose level",discrete = T,option='rocket',begin =.3,end=.8)+
...
datforposterplot<-subset(datforposter,datforposter$Lipid.level!='8x Lipid')
# plot
plot1<-ggplot(datforposterplot,aes(x=factor(condition),y=CCR7countperul))+
  stat_summary(fun=mean, geom="col",aes(fill=Glucose.level))+ 
  geom_jitter(aes(color=Lipid.level),alpha=.8,size=.75)+
  scale_color_viridis("Lipid Level",discrete=T,option = 'mako',begin =.3,end=.8)+
  scale_fill_viridis("Glucose level",discrete = T,option='rocket',begin =.3,end=.8)+
...
# plot
plot2<-ggplot(datforposterplot,aes(x=factor(condition),y=freq.CCR7pos))+
  stat_summary(fun=mean, geom="col",aes(fill=Glucose.level))+ 
  geom_jitter(aes(color=Lipid.level),alpha=.8,size=.75)+
  scale_color_viridis("Lipid Level",discrete=T,option = 'mako',begin =.3,end=.8)+
  scale_fill_viridis("Glucose level",discrete = T,option='rocket',begin =.3,end=.8)+
...
# plot
plot1<-ggplot(datforposterplot,aes(x=factor(condition),y=CD49aCD103DPcountperul))+
  stat_summary(fun=mean, geom="col",aes(fill=Glucose.level))+ 
  geom_jitter(aes(color=Lipid.level),alpha=.8,size=.75)+
  scale_color_viridis("Lipid Level",discrete=T,option = 'mako',begin =.3,end=.8)+
  scale_fill_viridis("Glucose level",discrete = T,option='rocket',begin =.3,end=.8)+
...
# plot
plot2<-ggplot(datforposterplot,aes(x=factor(condition),y=DPcd49acd103))+
  stat_summary(fun=mean, geom="col",aes(fill=Glucose.level))+ 
  geom_jitter(aes(color=Lipid.level),alpha=.8,size=.75)+
  scale_color_viridis("Lipid Level",discrete=T,option = 'mako',begin =.3,end=.8)+
  scale_fill_viridis("Glucose level",discrete = T,option='rocket',begin =.3,end=.8)+
